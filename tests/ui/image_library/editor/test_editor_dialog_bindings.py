...
def test_editor_keyboard_shortcuts_are_bound(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr(ImageEditorDialog, "transient", lambda self, _master: None)
    ...
    monkeypatch.setattr(ImageEditorDialog, "_build_header", lambda self: None)
    monkeypatch.setattr(ImageEditorDialog, "_build_workspace", lambda self: None)
    monkeypatch.setattr(ImageEditorDialog, "_build_controls", lambda self: None)
