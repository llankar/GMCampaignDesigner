    ...
    def save_story_arc(self, arc: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for scenario in scenarios:
            ...
            item = {
                ...
                "Scenes": hooks + (scenario.get("DowntimeHooks", []) if isinstance(scenario.get("DowntimeHooks", []), list) else []),
                "Bases": scenario.get("KeyBases", []) if isinstance(scenario.get("KeyBases", []), list) else [],
