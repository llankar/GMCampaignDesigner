        ...
        return render_template_string(
            ...
            <head>
                ...
                <style>
                    ...
                    .token { position: absolute; width: 48px; height: 48px; border-radius: 12px; background: rgba(14,165,233,0.85); border: 2px solid rgba(255,255,255,0.8); color: #0b1220; font-weight: 800; display: grid; place-items: center; pointer-events: auto; touch-action: none; box-shadow: 0 10px 25px rgba(0,0,0,0.35); text-shadow: 0 1px 2px rgba(255,255,255,0.5), 0 0 6px rgba(15,23,42,0.65); user-select: none; -webkit-user-drag: none; }
