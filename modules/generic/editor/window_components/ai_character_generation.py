    ...
    def ai_generate_full_npc(self):
        ...
        try:
            ...
            user = (
                ...
                "  \"Name\": string,\n"
                "  \"Role\": string,\n"
                "  \"Description\": string (1 short physical/visual paragraph suitable for AI image generation; include age, build, face, hair, clothing, colors, posture, props, and mood; do not include Atouts),\n"
                "  \"Secret\": string,\n"
                "  \"Quote\": string,\n"
                ...
                "  \"Motivation\": string,\n"
                "  \"Background\": string,\n"
                "  \"Traits\": string (include any Atouts/advantages here, never in Description),\n"
                "  \"Genre\": string\n"
                "}\n"
