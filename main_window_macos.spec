...
exe = EXE(
    ...
    # PyInstaller macOS bundles ignore Windows .ico/version resources and no .icns is tracked, so omit them.
)
...
app_bundle = BUNDLE(
    exe,
    # Use a macOS .app bundle for the main GUI executable.
    name='RPGCampaignManager.app',
)
coll = COLLECT(
    app_bundle,
    update_exe,
